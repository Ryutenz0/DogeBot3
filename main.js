...
console.log(color('> WA NUMBER: +6283819082780 ','silver'))
console.log(color('  Xeon Bot Inc. 2022','mediumseagreen'))
    ...
    console.log(color('<>','red'), color('But? Error? Suggestion? Visit Here:', 'aqua'), color('https://wa.me/6283819082780'))
    ...
    DogeXeonOP.sendMessage(`6283819082780@s.whatsapp.net`, `Thanks bro, your bot is working on my whatsapp number ez😂`, MessageType.extendedText)
